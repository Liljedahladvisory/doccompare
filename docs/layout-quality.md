...
## Export utan bubblor 0.3.0a13

0.3.0a12 lämnade Words celländringsbubblor och grå granskningsmarginal i PDF:en trots begäran om enbart markeringar i texten. Att sätta in-line-läget sist och stänga av kommentarer räckte inte. Exporten skapar nu en separat visningskopia där historik för format- och cellegenskaper tas bort, medan aktuella egenskaper, tabeller och alla textrevisioner behålls. Cellmarkörer får bara tas bort om synligt cellinnehåll redan har motsvarande textrevision; annars stoppas exporten. Innehållsprojektionen kontrolleras även mellan spårad källa och exportkopia. Word får sedan exportera kopian med kommentarer och formateringsändringar dolda. Den tidigare återhämtningen för fältexport utgår också från denna kopia.

Det reproducerade rapportparets 68 dokumentsidor saknar nu cellbubblor och granskningsmarginal. Ingen PDF-beskärning används. De ursprungliga kontrollkopiorna och revisionsstatistiken bygger fortfarande på Words validerade jämförelse, innan visningskopian skapas. De två tidigare problemdokumentparen kontrolleras också, inklusive fältåterhämtning.

ckglib kartlade `word_bridge.comparison_script`. Den nya exportmodulen och dess tester, fältexporttesternas nya arbetskopia, versionsfiler, bootstrap-importkontroll och dokumentation är granskade tillägg utanför den bakåtriktade anropsplanen. Service, CLI och adapter har oförändrade anrop. Ett native-test för tillagd tabellkolumn kontrollerar även att cellbubblornas etiketter saknas i PDF-texten.

Verifiering: 95 tester godkända, inklusive 18 Word-tester. Efter justering för historiska tabbstopp godkändes de 15 berörda exporttesterna, Word-testet för cellbubblor och båda tidigare dokumentparen (61 respektive 24 sidor). Aktuella textrevisioner och hela innehållsprojektionen bevaras; originalfilerna ändras inte.

...
6. Läs statistiken från Words faktiska revisioner och exportera med Word först efter godkänd kontroll. En separat kontrollerad exportkopia behåller textrevisionerna men utelämnar format- och cellbubblor samt granskningsmarginalen. Vid det specifika exportfelet -1708 får Word ett nytt försök med säkert avgränsade, ändrade fälts befintliga visningsvärden i en separat exportkopia. Text, revisionsmarkeringar och layout behålls. Sidnummerfält förblir aktiva; fält utan ett säkert separerbart visningsvärde lämnas oförändrade. Åtgärden anges i sammanfattning och PDF-metadata.
